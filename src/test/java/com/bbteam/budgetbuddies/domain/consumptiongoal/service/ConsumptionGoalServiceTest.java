...
@DisplayName("ConsumptionGoalImpl 서비스 테스트")
...
class ConsumptionGoalServiceTest {
	...
	void getTopCategoryAndConsumptionAmount_Success() {
		...
		given(consumptionGoalRepository.findTopCategoriesAndGoalAmountLimit(1, 23, 25, Gender.MALE)).willReturn(
	...
	void getTopGoalCategories_Success() {
		...
		given(userRepository.findById(user.getId())).willReturn(Optional.of(user));
		given(consumptionGoalRepository.findTopCategoriesAndGoalAmountLimit(4, 23, 25, Gender.MALE)).willReturn(
	...
	void getTopConsumptionCategories_Success() {
		...
		given(userRepository.findById(user.getId())).willReturn(Optional.of(user));
		given(consumptionGoalRepository.findTopConsumptionAndConsumeAmountLimit(3, 23, 25, Gender.MALE)).willReturn(
				List.of(topConsumptionGoal1, topConsumptionGoal2, topConsumptionGoal3));

		// when
		List<TopConsumptionResponseDTO> result = consumptionGoalService.getTopConsumptionLimit(3, user.getId(), 23, 25,
				"MALE");
