...
public class SupportCommentService implements CommentService<CommentRequestDto.SupportInfoCommentDto,
    ...
    @Override
    @Transactional
    public CommentResponseDto.SupportInfoCommentDto modifyComment(CommentRequestDto.SupportInfoCommentDto dto) {
